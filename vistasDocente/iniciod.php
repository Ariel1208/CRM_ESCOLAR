        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="iniciod.php">Inicio</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-danger" type="submit" id="btnLogOut"> <i class="fas fa-sign-out-alt"></i> Cerrar Sesión</button>
                </form>
            </div>
        </div>
    </nav>
    <div style="text-align: center; margin-top:10%" >
        <img id="imgIsc" src="../img/isc.png" />
      </div>
    </div>
